process TRIMMOMATIC {
    ...
    if ( meta.single_end ) {
        ...
        trimmed = "SE"
        output = "${prefix}.SE.paired.trim.fastq.gz"

    } else {

        trimmed = "PE"
        output = "${prefix}.paired.trim_1.fastq.gz ${prefix}.unpaired.trim_1.fastq.gz ${prefix}.paired.trim_2.fastq.gz ${prefix}.unpaired.trim_2.fastq.gz"
